...
function LedegerReportModal({handleClose,show}) {
    return (
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <div className="form-group">
                                    ...
                                    <input type="text" id="download_menu_name disabled b-radius-none" className="form-control" defaultValue="Ledger Report " readOnly />
                                </div>
                            </div>
                            <div className="col-sm-12">
                                <div className="form-group">
...
export default LedegerReportModal
