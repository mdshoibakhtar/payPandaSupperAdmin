...
function DebitReportModal(props) {
    return (
        <Modal
            {...props}
            size="lg"
                    ...
                    <div className="row">
                        <div className="col-sm-12 mt-3">
                            <div className="form-group">
                                ...
                                <input type="text" id="download_menu_name" className="form-control" defaultValue="Debit Reoprt" readOnly />
                            </div>
                        </div>
                        <div className="col-sm-12 mt-3">
                            <div className="form-group">
...
export default DebitReportModal
