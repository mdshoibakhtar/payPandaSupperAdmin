                            ...
                            <div className="card">
                                <div className="card-header pb-0">
                                    <div className="d-flex justify-content-between">
                                        <h4 className="card-title mg-b-2 mt-2">Role Master</h4>
                                                    ...
                                                    <table className="table-all">
                                                        ...
                                                        <tbody>
                                                            <tr role="row" class="odd border-top border-bottom border-primary">
                                                                ...
                                                                <td>Api Patner</td>
                                                                <td>
                                                                    <span className='bg-warning  py-1 px-2 rounded'><Link to={"/edit-role-master"} className='text-light text-decoration-none'><FaRegEdit className='FaRegEdit' />Edit</Link></span>
                                                                </td>
                                                            </tr>
                                                            <tr role="row" class="odd border-top border-bottom border-primary">
                                                                <td> 2</td>
